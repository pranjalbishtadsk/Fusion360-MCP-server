"""
Example: Box with Rounded Corners

This script demonstrates how to create a box with rounded corners in Fusion 360.
It was generated by the Fusion 360 MCP Server.
...
def run(context):
    ...
    try:
        ...
        ui.messageBox('Box with rounded corners created successfully')
    except:
        if ui:
